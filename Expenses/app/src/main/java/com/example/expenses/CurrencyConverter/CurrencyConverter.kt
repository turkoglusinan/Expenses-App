...
class CurrencyConverter(private val currencyType: Int, private val list: ArrayList<Double>): RecyclerView.Adapter<ExpenseRecyclerAdapter.ExpenseViewHolder>() {

    private var expenseList = emptyList<expense_table>()
    ...
    override fun onBindViewHolder(holder: ExpenseViewHolder, position: Int) {
        ...
        when(currentItem.billType){
            0 -> holder.itemBinding.imageViewImage.setImageResource(R.drawable.bill_icon)
            1 -> holder.itemBinding.imageViewImage.setImageResource(R.drawable.rent_icon)
            2 -> holder.itemBinding.imageViewImage.setImageResource(R.drawable.other_icon)
        }
        when(currencyType){
